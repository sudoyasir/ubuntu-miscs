...
clock_table = {
    ...
    fill_color = {0xFFFFFF, 1}, -- fill color for hour+minutes ring
    fill_colorS = {0xFFFFFF, 1}, -- fill color for seconds ring
    ...
    hour_font = "Lion",
    hour_font_size = 0, -- font face+size for hours
    min_font = "Lion",
    min_font_size = 0, -- font face+size for minutes
    sec_font = "Lion",
    sec_font_size = 0, -- font face+size for seconds
    day_font = "Lion",
    day_font_size = 0 -- font face+size for the day
}
-----------------------------------------------------------------------------------------------------------------------------------------------
--
